                    ...
                    <tbody>
                        @foreach ($termins as $termin)
                            <tr>
                                ...
                                {{-- @can('isSuperAdmin') --}}
                                <td class="text-center">
                                    @if ($termin->status_pembayaran == 'Payment Succesfull' || $termin->status_termin == 'not payable')
                                    ...
                                    @elseif ($termin->status_termin == 'payable')
                                        <div class="align-items-center gap-2">
                                            <button data-id_termin="{{ $termin->id }}"
                                                class="pay-button button-edit">Pay</button>
                                        </div>
                                    @endif
                                    {{-- @if ($termin->status_termin == 'payable')
                                        <div class="align-items-center gap-2">
                                            <button data-id_termin="{{ $termin->id }}"
                                                class="pay-button button-edit">Pay</button>
                                        </div>
        ...
        $(document).ready(function() {
            $('.pay-button').each(function() {
                $(this).on('click', function() {
                    let terminId = $(this).data('id_termin');
                    let snapContainer = 'snap-container-' + terminId;
