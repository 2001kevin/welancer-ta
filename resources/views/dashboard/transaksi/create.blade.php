    ...
    <div class="container">
        <form action="{{ route('store-transaksi') }}" method="POST">
            ...
            <div class="float-start w-75">
                <div class="form-container">
                    <div class="card border-0 shadow-sm mb-3 p-3">
                        <div class="card-body">
                            ...
                            <input type="text" name="name_project" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="card border-0 shadow-sm p-3">
                        <div class="card-body">
                            <div class="header mb-3">
                                ...
                                <ul id="service" class="flex justify-center">
                                </ul>
                ...
                <div>
                    <button class="badge bg-secondary mt-3 p-3" type="button" id="button-add" onclick="addForm()"><i
                            class="fa-solid fa-plus me-2"></i>Add More Service</button>
                </div>
                        ...
                        <div class="card w-75 rounded-3 mb-3">
                            <div class="card-body">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="service_tambahan[]" value="{{ $jasa->id }}" data-min="{{ $jasa->min_price }}" data-max="{{ $jasa->max_price }}" id="service-${count}">
        ...
        document.getElementById('kategori').addEventListener('change', function() {
            ...
            @foreach ($jasas as $jasa)
                if ("{{ $jasa->kategori->id }}" == selectedCategoryId) {
                    serviceRadio.innerHTML += `
                        <li class="flex">
                            <input type="checkbox" id="service-option-{{ $jasa->id }}" value="{{ $jasa->id }}" data-min="{{ $jasa->min_price }}" data-max="{{ $jasa->max_price }}" name="service[]" class="peer hidden" required=""/>
