  ...
  <section class="background h-full flex justify-center py-48">
      <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl">
          ...
          <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
              ...
              <a href="{{ route('login-admin') }}" class="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-gray-50">
                  {{-- <div class="px-4 py-2">
              ...
              <div class="flex items-center justify-between mt-4">
                  ...
                  <a href="{{ route('register') }}" class="text-xs text-gray-500 uppercase hover:underline">or sign up</a>
